 ...
 * 2) process.env.FRONTEND_BACKEND_BASE_URL (preferred for this project)
 * 3) process.env.REACT_APP_BACKEND_URL (backward compatibility)
 * 4) Default to the provided URL: https://vscode-internal-13141-beta.beta01.cloud.kavia.ai:3001
 *
...
export function getBackendUrl() {
  ...
  if (typeof window !== 'undefined' && window.__BACKEND_URL__) {
    ...
    url = 'https://vscode-internal-13141-beta.beta01.cloud.kavia.ai:3001';
